...
package me.zgoralewska.iwarm.geofenceConfig;
...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CURRENT_COORDINATES =
            "com.example.android.geofence.ACTION_CURRENT_COORDINATES";
    ...
    public static final String ACTION_GPS_STATUS_CHANGE = "android.location.PROVIDERS_CHANGED";
    ...
    public static final float MIN_RADIUS = 500f;
    ...
    public static final String enterStatus = "W domu";

    public static final String exitStatus = "Poza domem";

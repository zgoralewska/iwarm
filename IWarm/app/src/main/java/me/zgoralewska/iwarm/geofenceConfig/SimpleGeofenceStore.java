...
public class SimpleGeofenceStore {
    ...
    public void setUserHouseId(String houseId){
        Editor editor = mPrefs.edit();
    ...
    public String getUserHouseId(){
        return mPrefs.getString("houseId", "");
    }

    public void setAppGpsStatus(int s){
        Editor editor = mPrefs.edit();

        editor.putInt("gpsStatus", s);

        editor.commit();
    }

    public int getAppGpsStatus(){
        return mPrefs.getInt("gpsStatus", 0);
    }
